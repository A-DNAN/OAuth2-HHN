...
import AlertComponent from "../../../component/alertComponent/AlertComponent";
 ...
 export class AddMuseumComponent extends Component {
   constructor(props) {
     super(props);
    ...
    ikOnError(err){
      ...
      this.setState({
        alertOpen: true,
         alertMessage: "Museum image can't be added please try again later",
         alertSeverity: "error"
      });
    ...
    ikOnSuccess(res){
     ...
     this.setState({
       ...
       alertOpen: true,
        alertMessage: "Museum image added successfully",
        alertSeverity: "info"
     });
    }else {
      this.setState({
   ...
   handleSubmit(e) {
    ...
    this.setState({
     ...
     axios.post(`${process.env.REACT_APP_RSERVER_URL}/museum/add`,{
         name: name,
       ...
       //  console.log(mainImage);
         ...
         this.setState({
          ...
          alertOpen: true,
          alertMessage: "Museum created successfully",
       ...
       this.setState({
        alertOpen: true,
        alertMessage: "Museum can't be created, Please try again later",
        alertSeverity: "error"
      });
     ...
     return (
       <Fragment>
         ...
         <form onSubmit={this.handleSubmit}>
           <div className="AaddPage" style={{background: "url('images/img-museum.jpg') center center/cover no-repeat"}}>
             <div className="AaddFormular">
               <h1 className="AFormH1">Add Museum</h1>
 ...
 export default AddMuseumComponent;
