...
export class AddHotelComponent extends Component {
  constructor(props) {
    super(props);
  ...
  ikOnError(err){
    ...
    this.setState({
       alertOpen: true,
       alertMessage: "Hotel image can't be added please try again later",
       alertSeverity: "error"
    });
  ...
  ikOnSuccess(res){
   ...
   this.setState({
     ...
     mainImage: "",
      ...
      alertOpen: true,
      alertMessage: "Hotel image added successfully",
      alertSeverity: "info"
   });
  }else {
    this.setState({
  ...
  handleSubmit(e) {
    ...
    axios.post(`${process.env.REACT_APP_RSERVER_URL}/erholung/add`,{
        name: name,
        art: "Hotel",
      ...
      //  console.log(mainImage);
        ...
        this.setState({
         ...
         alertOpen: true,
         alertMessage: "Hotel created successfully",
      ...
      .catch((error) => {
        ...
        this.setState({
          alertOpen: true,
          alertMessage: "Hotel can't be created, Please try again later",
          alertSeverity: "error"
        });
        // console.log(error);
      });
    ...
    return (
      <Fragment>
        ...
        <form onSubmit={this.handleSubmit}>
          <div className="AaddPage" style={{background: "url('images/img-hotel.jpg') center center/cover no-repeat"}} >
            <div className="AaddFormular">
              <h1 className="AFormH1">Add Hotel</h1>
