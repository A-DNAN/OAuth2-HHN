...
public class AltaegyptischeStaetteController {
    ...
    @GetMapping("/all")
    public ResponseEntity<Page<AltaegyptischeStaetteDTO>> getMuseums (
            @RequestParam("page") Integer page,
            @RequestParam(value = "size", required = false) Integer size
    ) {

        Page<AltaegyptischeStaetteDTO> altaegyptischeStaette = null;
        try {
            altaegyptischeStaette =  altaegyptischeStaetteService.findAll(page, size);
        ...
        return ResponseEntity.ok().body(altaegyptischeStaette);
    }

    @PostMapping("/add")
    public ResponseEntity<String> add(Authentication authentication,
                                      @RequestBody(required = true) AltaegyptischeStaetteDTO altaegyptischeStaetteDTO
    ){
        try {
            altaegyptischeStaetteService.save(altaegyptischeStaetteDTO, authentication);
